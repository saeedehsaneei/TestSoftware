   ...
   public class UserReqBLL
    {
       ...
       public Results<DataTable> UserReqSearch(int firstRow)
       {
           ...
           try
           {
               ...
               list = sHelper.searchUser(firstRow, firstRow + 6 - 1);
       ...
       public object SearchInTable(string Name, string UserName,int firstRow)
       {
           DataTable list = new DataTable();
            Results<DataTable> result = new Results<DataTable>();
            try
            {
                ...
                helperSearch sHelper = new helperSearch();
                list = sHelper.searchUser(firstRow, firstRow + 6 - 1,Name, UserName);
