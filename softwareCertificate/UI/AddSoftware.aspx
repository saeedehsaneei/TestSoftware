...
<%----------------------------------------------------------------------------DOCUMENT READY ----------------------------------------------------------------------------------------%>
     ...
     <script type="text/javascript" >
        $(document).ready(function () {
            ...
            $('#btnErtegha').click(function () {
                emptyElements('AddSoftware');
                validBack('AddSoftware');
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-primary">
        <div class="panel-title"><span><i class='fa fa-desktop'></i>&nbsp;اطلاعات نرم افزار ها</span></div>
           ...
           <div class="row">
                <div class="col-md-12">
                    <div class="form-group pull-left">
                        <span id="lblMessage" style="color:green; font:bold 12px tahoma"></span>
                         <button type="button" class="btn btn-success" data-toggle="modal" id="btnErtegha" data-target="#AddSoftware"  data-target=".bs-example-modal-lg"><i class="fa fa-plus"></i>&nbsp;اطلاعات مربوط به ارتقاء</button>
                        <button type="button" id="btnSave" class="btn btn-success">ذخیره اطلاعات</button>
                       <button type="button" class="btn btn-default" id="cancel">انصراف</button>
    ...
    <%--------------------------------------------------------------------------- MODAL ------------------------------------------------------------------------------------------%>
    <div class="modal fade bs-example-modal-lg" id="AddSoftware" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="gridSystemModalLabel1"><i class='fa fa-desktop'></i>&nbsp;اطلاعات مربوط به ارتقاء</h4>
                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group col-md-12"">
                                        <span class="input-group-addon">نام واحد درخواست کننده</span>
                                            <select  data-width="65%" id="ddVahed2" class="form-control required" >
                                            </select>
                                    </div>
                                </div>
                                <div class="form-group">
