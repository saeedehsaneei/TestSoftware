...
<%--------------------------------------------------------------------Functions---------------------------------------------------------------------%>
    <script type="text/javascript">
        ...
        function fillAndSearchTable() {
            ...
            var data = [SoftwareName, CompanyName, VahedValue, ZoneValue, StartDate, EndDate];
            $(document).data('arrData', data);
            loadGrid('TblSoftware', readReferencesCountForSearch, SearchInTable);

        };

        function createReq() {
            var request = {};
            if ($('#PatchUpdate1').prop("checked") == true) {
            ...
            if ($('#FtpUpdate1').prop("checked") == true) {
                request.isFtpUpdate = "1";
            }
            else {
                request.isFtpUpdate = "0";
            }
            if ($('#DirectAccessUpdate1').prop("checked") == true) {
            ...
            request.isHardwareLock = $('#ddLock10').find('option:selected').val();
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (result.IsSuccessfull) {
                                ...
                                loadGrid('TblSoftware', readReferencesCountForSearch, SoftwareReq);
        ...
        function FillCmbVahedAddSoftware() {
            ...
            $('#ddVahed1').append(' <option value="">انتخاب کنید</option>');
            $('#ddVahed2').append(' <option value="">انتخاب کنید</option>');
            try {
                $.ajax({
                    type: "POST",
        ...
        function FillCmbVahedAddSoftware1() {
        ...
        function FillCmbZoneAddSoftware() {
            ...
            $('#ddZone1').append(' <option value="0">همه حوزه ها</option>');
            try {
                $.ajax({
                    type: "POST",
        ...
        function FillCmbLanguageAddSoftware() {
            $('#ddLanguage').empty();
            $('#ddLanguage').append(' <option value="">انتخاب کنید</option>');
            try {
                $.ajax({
                    type: "POST",
        ...
        function FillCmbMemariAddSoftware() {
            $('#ddmemari').empty();
            $('#ddmemari').append(' <option value="">انتخاب کنید</option>');
            try {
                $.ajax({
                    type: "POST",
        ...
        function FillCmbDbAddSoftware() {
            $('#ddDb').empty();
            $('#ddDb').append(' <option value="">انتخاب کنید</option>');
            try {
                $.ajax({
                    type: "POST",
                        ...
                        if (response.d == null) {
                            ...
                            $.each(result.Value, function (index, c) {
                                ...
                                $('#TblSoftware').append('<tr style="background-color: ' + color + '" id="row_' + c.softwareCode + '"><td id="1col_' + c.softwareCode + '" style="text-align:center">' +
                                    //c.RowNo + '</td><td id="2col_' + c.softwareCode + '" style="text-align:center">' +
                                    c.softCodeDefine + '</td><td id="3col_' + c.softwareCode + '" style="text-align:center">' +
        ...
        function SearchInTable(firstRow) {
            ...
            $.ajax({
                ...
                data: JSON.stringify({ SoftwareName: arr[0], CompanyName: arr[1], VahedValue: arr[2], ZoneValue: arr[3], StartDate: arr[4], EndDate: arr[5], firstRow: firstRow }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
                success: function (response) {
        ...
        function fillModalUpgrade(id) {
            softwareCode = id;
            $.ajax({
                type: "POST",
                url: "SoftwareManage.aspx/UpgradeReqSeBySoft",
                data: JSON.stringify({ softwareCode: softwareCode }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
                success: function (response) {
                    try {
                        ...
                        if (response.d == null) {
                            ...
                            $.each(result.Value, function (index, c) {
                                $('#date').val(c.upgradeDate);
                                $('#description').val(c.description);
                                $('#ddVahed2').val(c.vahedCode);
                            });
                        }
                    }
                    catch (err) {
        ...
        function UpdateReqUpgrade(softwareCode) {
            var request = {};
            request.softwareCode = softwareCode;
            request.vahedCode = $('#ddVahed2').find('option:selected').val();
            request.upgradeDate = $('#date').val();
            request.description = $('#description').val();
            try {
                $.ajax({
                    type: "POST",
                    url: "SoftwareManage.aspx/updateUpgradeReq",
                    data: JSON.stringify({ rn: request }),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#Address').data('lenght', '100');
            $('#Address').data('lenght', '100');
            $('#Name').data('lenght', '100');
            $('#ServerLocation').data('lenght', '15');
            $('#Price').data('lenght', '11');
            $('#Company').data('lenght', '50');
            $('#subject').data('lenght', '40');
            $('#EndDate').data('lenght', '10');
            $('#SupportPrice').data('lenght', '11');
            $('#InstallDate').data('lenght', '10');
            $('#BuyNumber').data('lenght', '30');
            $('#Version').data('lenght', '10');
            $('#Supervisor').data('lenght', '50');
            $('#TelCo').data('lenght', '11');
            $('#NameN').data('lenght', '50');
            $('#Tel1').data('lenght', '11');
            $('#SupportTell').data('lenght', '11');
            $('#UserCount').data('lenght', '4');
            $('#Problem').data('lenght', '500');
            ...
            $("#btnAdd1").click(function () {
                FillCmbVahedAddSoftware1();
                $("#myModal1 :input").removeAttr("disabled");
            ...
            $('#btnEdit1').click(function () {
                UpdateReqUpgrade(softwareCode);
                $("#myModal1").modal("hide");
            });

            $('#btnSave1').click(function () {
                if (valid('myModal1') == true) {
                    code = 1;
            ...
            $("#TblSoftware").on('click', '.detail', function () {
                ...
                $("#myModal1 :input").attr("disabled", true);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-primary">
        <div class="panel-title"><span><i class='fa fa-desktop'></i>&nbsp;اطلاعات نرم افزارها</span></div>
        <div class="panel-body">
                ...
                <div class="col-md-12" style="padding-right:25px;padding-left:25px;">
                    <div class="form-group col-md-4" id="DivCompany">
                        <div class="input-group col-md-12">
                            ...
                            <input type="text" id="txtCompanyName" class="form-control" aria-describedby="basic-addon1" />
            ...
            <div class="row">
                <div class="col-md-12" style="padding-right:25px;padding-left:25px;">
                    <div class="form-group col-md-4" id="DivSoftware">
                        <div class="input-group col-md-12">
                            <span class="input-group-addon"> نام نرم افزار</span>
                            <input type="text" id="txtSoftwareName" class="form-control" aria-describedby="basic-addon1" />
                ...
                <div class="col-md-12" style="padding-right:25px;padding-left:25px;">
                    <div class="form-group col-md-4">
                        <div class="input-group col-md-12">
                            ...
                            <select id="ddVahed1" data-width="25%" class="form-control"></select>
                        </div>
                    </div>
                    <div class="form-group col-md-4">
                        <div class="input-group col-md-12">
                            <span class="input-group-addon">نام حوزه</span>
                            <select id="ddZone1" data-width="25%" class="form-control"></select>
                        </div>
                    </div>
                    <div class="form-group col-md-4">
                        <div class="input-group col-md-12">
                            <button type="button" class="btn btn-success pull-left" id="btnSearch"><i class="fa fa-search"></i>&nbsp;جستجو</button>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                ...
                <div class="col-md-12" style="padding-right:25px;padding-left:25px;">
                    <div class="form-group col-md-4">
                        <div class="input-group col-md-12">
                            ...
                            <input type="text" class="form-control date" aria-describedby="basic-addon1" id="txtStartDate" />
                        </div>
                    </div>
                    <div class="form-group col-md-4">
                        <div class="input-group col-md-12">
                            <span class="input-group-addon">تاریخ پایان</span>
                            <input type="text" class="form-control date" aria-describedby="basic-addon1" id="txtEndDate" />
                        </div>
                    </div>
                    <div class="form-group col-md-4">
                        <div class="input-group col-md-12">
                            <button type="button" class="btn btn-success pull-left" id="btnSearchDate"><i class="fa fa-search"></i>&nbsp;جستجو</button>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="gridSystemModalLabel"><i class="fa fa-pencil"></i>&nbsp;تعریف اطلاعات نرم افزار</h4>
                </div>

                <div class="modal-body" style="height: 450px;overflow-y: auto;background:#fff;">
                 ...
                 <div class="row">
                    <div class="form-group col-md-4">
                        <div class="input-group col-md-12">
                            ...
                            <select class="form-control" id="ddlCity" data-width="75%" >
                                <option value="">انتخاب کنید</option>
                                <option value="1">کرمان</option>
                                <option value="2">رفسنجان</option>
                                <option value="3">سیرجان</option>
                                <option value="4">بم</option>
                                <option value="5">بردسیر</option>
                                <option value="6">بافت</option>
                                <option value="7">جیرفت</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group col-md-4">
                        <div class="input-group col-md-12">
                            <span class="input-group-addon">نام واحد</span>
                            <select  data-width="75%" id="ddVahed" class="form-control required" >
                            </select>
                        </div>
                    </div>
                    <div class="form-group col-md-4">
                        <div class="input-group col-md-12">
                            ...
                            <select  data-width="75%" id="ddZone"  class="form-control required" >
                            </select>
                        </div>
                    </div>
                     </div>
                     </div>
                  <div class="back-top-box-2">
                     <div class="row">
                                <div class="form-group col-md-6">
                                    <div class="input-group col-md-12">
                                        <span class="input-group-addon">نام  نرم افزار</span>
                                        <input type="text" id="Name" class="form-control required lenght" aria-describedby="basic-addon1" />
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <div class="input-group col-md-12">
                                        <span class="input-group-addon">موضوع کاربرد نرم افزار</span>
                                        <input type="text" id="subject" class="form-control lenght" aria-describedby="basic-addon1" />
                                    </div>
                                </div>
                        </div>
                  </div>
                 ...
                 <div class="back-top-box" style="margin:0;">
                        <div class="row">
                            ...
                            <select  data-width="75%" id="ddLanguage"  class="form-control required" >
                            </select>       
                        </div>
                    </div>
                             <div class="form-group col-md-4">
                        <div class="input-group col-md-12">
                            ...
                            <select  data-width="75%" id="ddDb"  class="form-control required" >
                            </select>  
                             </div>
                    </div>
                             <div class="form-group col-md-4">
                                <div class="input-group col-md-12">
                                    ...
                                    <select  data-width="75%" id="ddmemari"  class="form-control required">
                                    </select>       
                                </div>
                    </div>
                        </div>
                 ...
                 <div class="back-top-box-2">
                    <div class="row">
                       <div class="form-group col-md-5">
                            ...
                            <input type="text" id="Company" class="form-control required lenght"  aria-describedby="basic-addon1" />
                           </div>
                        </div>
                            <div class="form-group col-md-4">
                             <div class="input-group col-md-12">
                            <span class="input-group-addon">نام نماینده شرکت</span>
                            <input type="text" id="NameN" class="form-control lenght"  aria-describedby="basic-addon1" />
                        </div>
                       </div>
                            <div class="form-group col-md-3">
                              <div class="input-group col-md-12">
                            <span class="input-group-addon">آخرین نسخه</span>
                            <input type="text" class="form-control lenght" id="Version"/>
                           </div>
                              </div>
                      </div>
                    <div class="row">
                            ...
                            <input type="text" class="form-control onlyNumber lenght" id="TelCo"/>
                            ...
                            <input type="text" class="form-control lenght" id="Supervisor"  />
                        </div>
                    </div>
                         </div>
                    <div class="row">
                            ...
                            <input type="text" class="form-control lenght" id="Address" />
                        </div>
                          </div>
                         </div>
                 </div>  
                 <div class="back-top-box" style="margin:0;">     
                        <div class="row">
                            ...
                            <input type="text" id="Price" class="form-control onlyNumber lenght"  aria-describedby="basic-addon1" />
                             </div>
                             </div>
                             <div class="form-group col-md-4">
                        <div class="input-group col-md-12">
                            <span class="input-group-addon">مبلغ قرارداد پشتیبانی(ریال)</span>
                            <input type="text" id="SupportPrice" class="form-control onlyNumber lenght"  />
                        </div>
                    </div>
                             <div class="form-group col-md-4">
                             <div class="input-group col-md-12">
                            <span class="input-group-addon">شماره قرارداد خرید</span>
                            <input type="text" class="form-control lenght" id="BuyNumber" />
                        </div>
                    </div>
                         </div>
                        <div class="row">
                        ...
                        <div class="input-group col-md-12">
                            ...
                            <input type="text" id="InstallDate" class="form-control date lenght"  aria-describedby="basic-addon1" />
                        </div>
                    </div>
                            <div class="form-group col-md-4">
                        <div class="input-group col-md-12">
                            <span class="input-group-addon">تاریخ اتمام پشتیبانی</span>
                            <input type="text" id="EndDate" class="form-control required date lenght"  />
                        </div>
                    </div>
                            <div class="form-group col-md-4">
                        <div class="input-group col-md-12">
                            <span class="input-group-addon"> شماره تماس پشتیبانی</span>
                            <input type="text" class="form-control onlyNumber lenght" id="SupportTell"  />
                        </div>
                    </div>
                          </div>
                  </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                     <div class="input-group col-md-12">
                         ...
                         <input type="text" class="form-control onlyNumber lenght"id="UserCount" />
                     </div>
                 </div>
                    <div class="form-group">
                      <div class="input-group col-md-12">
                           <span class="input-group-addon">محل قرار گرفتن سرور نرم افزار</span>
                            <input type="text" class="form-control lenght" id="ServerLocation"/>
          ...
          <div class="row">
            <div class="col-md-12 alert-info" style="padding: 15px;">
                <div class="form-group">
                        <label class="label" style="font:bold 14px BMitra;color:#0094ff;"> نحوه بروز رسانی : </label>
                    <%--  <hr />--%>
          ...
          <div class="col-md-12"><hr /></div>
            <div class="row">
                      <div class="col-md-12">
                          <div class="form-group">
                             <span class="label" style="color:#000; font:bold 14px BMitra;">مشکلات موجود در نرم افزار</span>
                              </div>
                          <div class="form-group">
                                    <textarea  class="form-control lenght" id="Problem" ></textarea>
                          </div>
                      </div>
             </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="btnAdd2" class="btn btn-success" data-toggle="modal" data-target="#myModal1" data-target=".bs-example-modal-lg">اطلاعات مربوط به ارتقا</button>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="gridSystemModalLabel1"><i class="fa fa-info-circle"></i>&nbsp;اطلاعات مربوط به ارتقاء</h4>
                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="input-group col-md-12" ">
                                                ...
                                                نام واحد درخواست کننده</span>
                                                <select data-width="65%" id="ddVahed2" class="form-control required"></select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group col-md-12">
                                                <span class="input-group-addon">تاریخ ارتقاء سیستم</span>
                                                <input type="text" class="form-control required date" id="date" aria-describedby="basic-addon1" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group col-md-12">
                ...
                <div class="modal-footer">
                    <button type="button" id="btnEdit1" class="btn btn-success">ویرایش اطلاعات</button>
                    <button type="button" id="btnSave1" class="btn btn-success">ذخیره اطلاعات</button>
                    <button type="button" id="btnCancel1" class="btn btn-default" data-dismiss="modal">انصراف</button>
                </div>
            </div>
        </div>
    </div>
